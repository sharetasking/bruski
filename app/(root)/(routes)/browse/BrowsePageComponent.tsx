...
<div>
    ...
    <div className="p-8 pb-48">
      ...
      <div className="flex md:grid cursor-pointer flex-col md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-4 ">
        {profiles?.map((profile) => (
          <div
            ...
            <h2 className=" truncate">{profile.display_name}</h2>
            <p className="truncate">{profile.url}</p>
            <hr className="mt-4"/>
            <p className="py-4 subpixel-antialiased line-clamp-3">{profile.bio}</p>
