...
<button onClick={toggleTheme} aria-label="toggle light and dark mode" className="h-[1.2rem] w-[1.24rem] grow-0 shrink-0">
<Sun className={cn("h-[1.24rem] w-[1.24rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0 ", theme != "light" && "hidden")} />
<Moon className={cn("h-[1.2rem] w-[1.2rem] rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100 text-primary ", theme != "dark" && "hidden")} />
<svg width="20px" height="20px" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" className={cn("h-[1.2rem] w-[1.2rem] light:text-primary  dark:text-white",  theme != "system" && "hidden")}>
